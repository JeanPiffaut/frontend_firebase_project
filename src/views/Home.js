    ...
    return (
        <div className="App">
            ...
            <header className="App-header">
                <ImageSEO defaultSrc={logo} placeholderSrc={logo} height={"192"} width={"192"} alt={"logo"} style={{width:'100%', height: "auto", aspectRatio: 192/192}}
                          sources={[{srcSet: logoSVG, type: "image/svg+xml"}]} className={"App-logo"} isCritic={true}/>
